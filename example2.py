...
@mcp.tool()
async def sketchio_draw_write(text: str) -> dict:
    """Open Sketch.io/sketchpad and draw a rectangle and write contents on it"""

    webbrowser.open("https://sketch.io/sketchpad/")
    time.sleep(3)

    # close the "upgrade" popup
    pyautogui.moveTo(870, 732)
    pyautogui.click()
    time.sleep(1)

    # select the line tool for pencil to draw rectangle
    pyautogui.moveTo(23, 211)
    pyautogui.click()
    time.sleep(1)
    pyautogui.moveTo(146, 190)
    pyautogui.click()
    time.sleep(1)
    pyautogui.moveTo(373, 595)
    pyautogui.click()
    time.sleep(1)

    # Select new sketch document
    pyautogui.moveTo(25, 669)
    pyautogui.click()
    time.sleep(1)
    pyautogui.moveTo(139, 361)
    pyautogui.click()
    time.sleep(1)
    pyautogui.moveTo(298, 638)
    pyautogui.click()
    time.sleep(1)
    ...
    pyautogui.click()
    time.sleep(1)
    pyautogui.write(f"FINAL ANSWER : {text}", interval=0.1)
    ...
    return {
        "content": [
            TextContent(type="text", text=f"Opened Sketch.io and added: {text}")
        ]
    }


@mcp.tool()
async def send_email_gmail_api(to_email: str, subject: str, message_text: str) -> dict:
    ...
    try:
        ...
        return {
            "content": [
                TextContent(
                    type="text",
                    text=f"Email sent to {to_email}. Message ID: {send_result['id']}",
                )
            ]
        }
        ...
        return {
            "content": [
                TextContent(
                    type="text", text=f"Error sending email via Gmail API: {str(e)}"
                )
            ]
        }
