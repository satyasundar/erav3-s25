    ...
    try:
        ...
        response = await asyncio.wait_for(
            loop.run_in_executor(
                None,
                lambda: client.generate_content(contents=prompt),
            ),
            timeout=timeout,
        )
        ...
        async with stdio_client(server_params) as (read, write):
            ...
            async with ClientSession(read, write) as session:
                ...
                system_prompt = f"""You are a math agent solving problems in iterations. You have access to various mathematical tools.
                            ...
                            - FUNCTION_CALL: sketch_draw_and_write|The final answer is 42
                            - FUNCTION_CALL: send_email_gmail_api|satyanayak2041@gmail.com|Math Agent Result|The final answer is 42
                            - FINAL_ANSWER: [42]
                ...
                Then write that value in text inside a rectangle using Sketch.io/sketchpad web link. also send an email"""
                print(f"Query: {query}")
                ...
                while iteration < max_iterations:
                    ...
                    if response_text.startswith("FUNCTION_CALL:"):
                        ...
                        # result = await session.call_tool(
                        #     "sketchio_draw_write", arguments={"text": response_text}
                        # )
